...
then
	...
	export TESTDIR=${HOME_RESULTS}/testdir
	...
	####################
	export TESTDIRSUFFIX=benchtestingdir
	export ETCDIRSUFFIX=${TESTDIRSUFFIX}/etc
	export LOCKFILENUMBERS=${HOME_RESULTS}/locknumbers
	export LOGFILE=${HOME_RESULTS}/benchlog.txt
	export TESTNUMBERFILE=${HOME_RESULTS}/TESTNUMBER
	export BATCHNUMBERFILE=${HOME_RESULTS}/BATCHNUMBER
	mkdir -p ${TESTNUMBERFILE%/*}
