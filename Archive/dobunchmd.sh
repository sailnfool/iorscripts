...
do
	echo "md2runner -f ${filesystem} -p 50 ${proclist}"
	md2runner -f ${filesystem} -p 50  ${proclist}
	echo "md2runner -f ${filesystem} -p 10 ${proclist}"
	md2runner -f ${filesystem} -p 10  ${proclist}
done
