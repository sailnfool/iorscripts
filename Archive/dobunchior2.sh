...
do
	echo "ior2runner -f ${filesystem} -p 50 -o "-Y" ${proclist}"
	ior2runner -f ${filesystem} -p 50  -o "-Y" ${proclist}
	echo "ior2runner -f ${filesystem} -p 10 -o "-Y" ${proclist}"
	ior2runner -f ${filesystem} -p 10  -o "-Y" ${proclist}
	echo "ior2runner -f ${filesystem} -p 50  ${proclist}"
	ior2runner -f ${filesystem} -p 50  -o ${proclist}
	echo "ior2runner -f ${filesystem} -p 10 ${proclist}"
	ior2runner -f ${filesystem} -p 10  -o ${proclist}
done
